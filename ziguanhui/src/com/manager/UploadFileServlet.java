...
public class UploadFileServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException {
		request.setCharacterEncoding("UTF-8");// 需要把设置编码配置到过滤器当中
		response.setContentType("text/html; charset=UTF-8");
		PrintWriter out = response.getWriter();
		
//		
//		String savePath = "d:/" + "upload/";
//		String saveUrl  = "test/upload/";
		String savePath = "D:/ziguanhui/xinwen/";
	    String saveUrl = "test/xinwen/";


//		request.getContextPath()
//		String savePath = getServletContext().getRealPath("/") + "upload/";
//		String saveUrl  = getServletContext().getRealPath("/") + "upload/";
//		
		...
		while (itr.hasNext()) {
			...
			if (!item.isFormField()) {
				...
				if(dirName.equals("image")){
					obj.put("error", 0);
					obj.put("url", "getimage?saveurl="+savePath+newFileName);
				}
				else{
					obj.put("error", 0);

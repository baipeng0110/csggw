...
<html>
  <head>
	...
	<link rel="stylesheet" type="text/css" href="bjxwbj.css">
...
//-->
  ...
  <img src="image/beijing2.jpg" style="width:100%;height:auto;position:relative;"/ >
  <div  style=" position: absolute;  left: 300px; top:120px; background-color:#0DAD67; ">
    <center><font size="6" color="red"><b>编辑新闻</b></font></center><br>
  	<center><form name="example" method="post" action="InsertServlet" onsubmit="return checkForm();">
  	新闻标题：<input type="text" name="biaoti">
  	
  	 
	   <textarea name="content" cols="100" rows="20" style="width:700px;height:400px;visibility:hidden;"></textarea>
	 作者：<input type="text" name="zuozhe"><br>
	 时间：<%=time %><input type="hidden" name="time" value="<%=time%>"><br>
	 所属类别<select id="s1" name="s1"><option>一级分类</option></select>
<select id="s2" name="s2"><option>二级分类</option></select> 
